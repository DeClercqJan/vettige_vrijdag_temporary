...
Encore
  ...
  // separate entry, otherwise incorrect render on pages that do not use react
  .addEntry('reactApp', './assets/js/reactApp.js')
  ...
  .configureLoaderRule('eslint', (loaderRule) => {
    ...
    loaderRule.use = ['babel-loader', 'eslint-loader'];
  })
